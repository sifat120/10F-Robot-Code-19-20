...
void intakeCube(int degrees, int intakeSpeed) {
  lFront.stop(brakeType::brake);
  lBack.stop(brakeType::brake);
  rFront.stop(brakeType::brake);
  rBack.stop(brakeType::brake);

  leftLift.spin(directionType::rev, degrees, velocityUnits::pct);
  rightLift.spin(directionType::rev, degrees, velocityUnits::pct);
...
void blueLeft() {
  ...
  //Set lift down (reverse rollers and go up)
